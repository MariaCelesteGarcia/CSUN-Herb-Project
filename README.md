...
<param ve-image 
       manifest="<img style="-webkit-user-select: none;margin: auto;cursor: zoom-in;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="https://images.metmuseum.org/CRDImages/dp/original/DP-12527-001.jpg" width="702" height="657">">
